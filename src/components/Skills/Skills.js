...
const WordClouds = () => {
  return (
    ...
    >
      ...
      <p style={{ top: 0, left: 0, fontSize: 25 }}>Discord bots</p>
      <p style={{ top: 200, left: -60, fontSize: 14 }}>CSS3</p>
      <p style={{ top: '30%', left: '35%', fontSize: 18 }}>Whatsapp bots</p>
      <p style={{ top: 40, left: '75%', fontSize: 12 }}>Json</p>
...
const Skills = () => (
  <SkillsWrapper>
    <ParallaxProvider>
      <PageHeader>Cada vez mais buscando conhecimento em</PageHeader>
